# Домашнее задание к занятию «Системы контроля версий» - Липовецкий Александр
...
У меня уже был зарегистрирован аккаунт и начиная в 8 модуля я сдавал все задания в репозитории DevOps_Netology_HW, поэтому я добавил в нем директорию 14 для настоящего модуля, в котором выполнил все шаги, начиная с 7 шага, так как шаги 1-6 мной выполнены ранее, при создании репозитория.
